          ...
          itemBuilder: (BuildContext context,j){
            return ListTile(
                onTap:(){
                  ...
                  datosPersona p = datosPersona(personasLista[j]['nombre'], personasLista[j]['apellido'], personasLista[j]['correo'], personasLista[j]['foto'], personasLista[j]['edad'], personasLista[j]['web']);
